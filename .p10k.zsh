# Generated by Powerlevel10k configuration wizard on 2023-07-17 at 21:57 BST.
...
() {
  ...
  function custom_git_username {
    p10k segment -f 202 -i 'gitconfig_icon' -t "$(git config user.name)" 
  }
